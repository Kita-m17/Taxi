...
public class Graph
{
   ...
   public void addEdge( String sourceName, String destName, double cost )
   {
     ...
     */
   public void printPath( String sourceName, String destName )
   {
      dijkstra(sourceName);
      ...
      while( !pq.isEmpty( ) && nodesSeen < vertexMap.size( ) )
      {
         ...
         for( Edge e : v.adj )
         {
            ...
            if( w.dist > v.dist + cvw )
            {
               ...
               w.hasMultipleSolutions = false;
            }
            else if( w.dist == v.dist + cvw ){
               w.hasMultipleSolutions = true;
            }
         }
      }
   }
   
   public double getShortestDistance(String sourceName, String targetName){
   ...
   public List<String> getShortestPath(String sourceName, String targetName){
      Vertex source = vertexMap.get(sourceName);
      Vertex target = vertexMap.get(targetName);
   ...
   private List<String> getPath(Vertex source, Vertex target){
      ...
      if(current == null){
         throw new NoSuchElementException("No path exists from source to target");
      }
      path.add(source);
